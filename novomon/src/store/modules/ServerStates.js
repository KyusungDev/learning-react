...
// 타입's
const GET_SERVER_STATES = 'ServerStates/GET_SERVER_STATES';

// 액션's
export const getServerStates = createAction(GET_SERVER_STATES);
...
export const getServerStatesAsync = callback => dispatch => {
  // v1/hosts
...
export default handleActions(
  {
    [GET_SERVER_STATES]: (state, action) => {
      return produce(state, draftState => {
        draftState.serverStates = action.payload.serverStates;
      });
    }
  },
  initialize
